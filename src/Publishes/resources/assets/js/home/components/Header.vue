        ...
        <nav class="navbar navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    <a href="/home/index" class="navbar-brand"><b>{{app_name}}</b></a>
                    <button type="button" class="navbar-toggle"  @click="sidebarToggle">
                        <i class="fa fa-bars"></i>
                    </button>
                </div>
                <div class="collapse navbar-collapse pull-left" :class="{'in':sidebarCollapse}">
                    <ul class="nav navbar-nav" v-if="menus">
                        <li :class="{'active':menu['active'],'dropdown':menu['childrens']}" v-for="menu in menus" v-if="menu['status']==1">
                            <a :href="(menu['url'] && !menu['childrens']) ? menu['url'] : null" :class="menu['childrens'] ? 'dropdown-toggle' : ''" :data-toggle="menu['childrens'] ? 'dropdown' : null">
                                <i class="fa" :class="menu['icons']"></i>
                                {{menu['name']}}
                                <span class="caret" v-if="menu['childrens']"></span>
                            </a>
                            <ul class="dropdown-menu" v-if="menu['childrens']">
                                <li :class="{'active':child['active']}" v-for="child in menu['childrens']" v-if="child['status']==1">
                                    <a :href="(child['url'] && !child['active']) ? child['url'] : null">
                                        <i class="fa" :class="child['icons']"></i>
                                        {{child['name']}}
                                    </a>
                                </li>
                            </ul>
                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown messages-menu" v-if="news['messages']">
                            ...
                            <ul class="dropdown-menu" v-if="news['messages']['total']">
                                ...
                                <li class="footer"><a href="/home/notification/index?where[type]=App\Notifications\Message">查看所有</a></li>
                            </ul>
                        </li>
                        <li class="dropdown notifications-menu"  v-if="news['notifications']">
                            ...
                            <ul class="dropdown-menu" v-if="news['notifications']['total']">
                                ...
                                <li class="footer"><a href="/home/notification/index?where[type]=App\Notifications\Notification">查看所有</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown tasks-menu"  v-if="news['tasks']">
                            ...
                            <ul class="dropdown-menu" v-show="news['tasks']['total']">
                                ...
                                <li class="footer">
                                    <a href="/home/notification/index?where[type]=App\Notifications\Task">查看所有</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="/home/personage/index" class="btn btn-default btn-flat">个人中心</a>
                                    </div>
